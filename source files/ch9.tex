...
\noindent Technically, $\alpha$ is a function of $D$ but as $D$ goes to infinity, $\alpha$ approaches a constant value. 
The calculus to find $\lim\limits_{D\to\infty}\alpha$ is quite involved so we just skip to stating 
$\alpha \approx 1.29281$ for large $D$.

...
The above figure shows a treap.
...
child {
    ...
    child {
		node [fill=red!73](3){$6,60$}
		child{node(4)[fill=red!73]{5,10}}
		child{node{}}
	}
}
child {
...
The heap property is still violated since
...
The BST property is also preserved because rotations never change the
in-order ordering of keys.

\paragraph{Final Treap}
...
Hence the insertion of $(5,10)$ is complete.
